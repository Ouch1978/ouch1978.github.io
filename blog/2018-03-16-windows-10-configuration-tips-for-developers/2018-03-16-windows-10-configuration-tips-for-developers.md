...
[![透過本機群組原則編輯器啟用 PIN][image-01]][image-01]
...
[![透過修改登錄機碼啟用 PIN][image-02]][image-02]
...
[![透過右鍵選單選擇要套用桌布的螢幕][image-03]][image-03]
...
[![修改檔案總管起始的路徑為本機][image-06]][image-06]
...
[![將捷徑的名稱改為 File Explorer][image-10]][image-10]
...
[![停止把最近使用的檔案和資料夾加入快速存取][image-11]][image-11]
...
[![透過 Winaero Tweaker 隱藏本機下面的資料夾][image-12]][image-12]
